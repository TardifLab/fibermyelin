...
if (myargs.myresult_input_filename):
    ...
    for i in range (0,iters):
        ...
        mtr_output_iter = '/data_/tardiflab/ilana/mt-diff/qmt_diff_fat_20201201_104549/sim/1pc-mtrb0-3/mtr_00{}'.format(
        str(i))
        ...
        subprocess.call(['/data/mril/mril5/ilana/bin/fibermyelin/scripts/fiberMTmyelin_pipeline.py',
                     ...
                     '-mtr', mtr_output_iter,
                     '-Dpar',
                     '/data_/tardiflab/ilana/mt-diff/qmt_diff_fat_20201201_104549/sim/1pc-mtrb0-3/Dpar.nii',
                     ...
                     '-AD','0.00155058',
                     '-RD','0.000316716',
                     #'-mtrB0','/data_/tardiflab/ilana/mt-diff/qmt_diff_fat_20201201_104549/mtr-b0s-we-PA.nii',
                     '-fixel',
                     '/data_/tardiflab/ilana/mt-diff/qmt_diff_fat_20201201_104549/sim/1pc-mtrb0-3/'])
