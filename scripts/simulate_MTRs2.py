...
if (myargs.myresult_input_filename):
    ...
    for i in range (0,iters):
        ...
        mtr_output_iter = '/data_/tardiflab/ilana/mt-diff/qmt_diff_fat_20201201_104549/sim/1pc-mtrb02/mtr_00{}'.format(
        str(i))
        ...
        subprocess.call(['/data/mril/mril5/ilana/bin/fibermyelin/scripts/fiberMTmyelin_pipeline.py',
                     ...
                     '-mtr', mtr_output_iter,
                     '-Dpar',
                     '/data_/tardiflab/ilana/mt-diff/qmt_diff_fat_20201201_104549/sim/1pc-mtrb02/Dpar.nii',
                     ...
                     '-fixel',
                     '/data_/tardiflab/ilana/mt-diff/qmt_diff_fat_20201201_104549/sim/1pc-mtrb02/'])
